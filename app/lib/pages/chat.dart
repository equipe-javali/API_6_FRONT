...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      try {
        ...
        throw Exception('Falha ao inicializar locale pt_BR: $e');
      }
  ...
  Future<void> _sendMessageToBackend() async {
    ...
    try {
      ...
      if (_userId == null) {
        await _loadCurrentUser(token);
        if (_userId == null) {
          throw Exception('Não foi possível determinar id do usuário');
        }
      }
  ...
  Future<void> _loadMessageHistory() async {
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        throw Exception(
            'Falha ao carregar mensagens: ${resp.statusCode} ${resp.body}');
      }
    } catch (e) {
  ...
  Future<void> _loadCurrentUser(String token) async {
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        throw Exception(
            'Falha ao obter usuário: ${resp.statusCode} ${resp.body}');
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final double bubbleMaxWidth =
        isDesktop ? (screenW * 0.45 > 700 ? 700 : screenW * 0.45) : 300;
                          ...
                          child: Center(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: color2.withValues(alpha: 0.16),
                        ...
                        content: Column(
                          children: messages.map((msg) {
                            ...
                            final time = DateFormat('HH:mm')
                                .format((msg['time'] as DateTime).toLocal());
                            ...
                            return Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      isUser ? color3 : const Color(0xFF2A2A35),
                                  border: Border.all(
                      ...
                      children: [
                        ...
                        IconButton(
                          icon: Icon(Icons.send,
                              color: color2, size: fontSize * 1.2),
  ...
  Widget build(BuildContext context) {
    ...
    return FadeTransition(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.color2.withValues(alpha: 0.15),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: widget.color2.withValues(alpha: 0.3)),
        ),
        constraints: const BoxConstraints(maxWidth: 200),
        child: Text(
          'Digitando$dots',
          style: TextStyle(
            color: widget.color4.withValues(alpha: 0.8),
